...
{
    public partial class FlaskTimerForm : Form
    {
        ...
        public FlaskTimerForm()
        {
            InitializeComponent();
        }

        private void FlaskTimerForm_Load(object sender, EventArgs e)
        {
            Visible = false;
            ...
            try
            {
                ...
                this.BackColor = StringRGBToColor(sColor);
                panel1.BackColor = StringRGBToColor(sColor);
            }
            catch
            {
            ...
            toolTip1.SetToolTip(this.label1, "클릭으로 이동 (Double to Move)");
        ...
        private void Timer1_Tick(object sender, EventArgs e)
        {
            ...
            label1.Text = lnFlaskTimer.ToString("N1");
            if (lnFlaskTimer < 0.1)
            {
                timer1.Stop();
                Close();
